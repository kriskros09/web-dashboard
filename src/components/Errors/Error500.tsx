...
const Error500Page: React.FC = (): ReactElement<'div'> => {
          ...
          <div className="container h-screen flex flex-col justify-center">
            <div className="w-full lg:w-9/12 mx-auto p-10 lg:p-20">
              <div className="text-center">
                ...
                <p className="text-7xl text-white font-extrabold uppercase mb-4">500</p>
                <p className="text-7xl text-white font-extrabold uppercase">
                  {t('translation:pageError:serverError.title')}
                </p>
                <p className="text-md text-white font-bold">
                  {t('translation:pageError:serverError.text')}
                </p>
                <Link className="btn text-primary bg-white inline-block mt-8" to="/">
                  {t('translation:pageError:serverError.button')}
                </Link>
              </div>
            </div>
          </div>
